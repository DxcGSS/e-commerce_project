...
public class ReferenceController {
	...
	@PostMapping(value = { "/admin/reference/provinces.html", "/shop/reference/provinces.html" })
	...
	@SuppressWarnings({ "unchecked", "deprecation" })
	@GetMapping(value = { "/shop/reference/creditCardDates.html" })
	...
	@SuppressWarnings({ "unchecked", "deprecation" })
	@GetMapping(value = { "/shop/reference/monthsOfYear.html" })
